...
<html lang="en">
<head>
    <title>Code coverage report for cypher-stream/CypherStream.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cypher-stream/CypherStream.js</span></h1>
    <h2>
        
        Statements: <span class="metric">86.6% <small>(84 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">82.98% <small>(39 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">93.33% <small>(14 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">86.6% <small>(84 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">cypher-stream/</a> &#187; CypherStream.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var oboe      = require('oboe');
...
function extractData(item) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (item.data) {
<span class="cstat-no" title="statement not covered" >    return extractData(item.data);</span>
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function transactionExpired () {</span>
<span class="cstat-no" title="statement not covered" >    self.emit('transactionExpired');</span>
  }
&nbsp;
...
&nbsp;
  stream.node('!errors[*]', function CypherStreamHandleError(error, path, ancestors) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (error.message) {
...
&nbsp;
  stream.on('fail', function CypherStreamHandleFailure(error) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!error.jsonBody) {
      // pass the Error instance through, creating one if necessary
      var err = error.thrown || <span class="branch-1 cbranch-no" title="branch not covered" >new Error('Neo4j ' + error.statusCode);</span>
    ...
    // handle neo4j errors
<span class="cstat-no" title="statement not covered" >    var message    = 'Query failure';</span>
<span class="cstat-no" title="statement not covered" >    var statusCode = 400;</span>
<span class="cstat-no" title="statement not covered" >    if (error.jsonBody.message) {</span>
<span class="cstat-no" title="statement not covered" >      message += ': '+error.jsonBody.message;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (error.jsonBody.statusCode) {</span>
<span class="cstat-no" title="statement not covered" >      statusCode = error.jsonBody.statusCode;</span>
    }
<span class="cstat-no" title="statement not covered" >    var err = new Error(message);</span>
<span class="cstat-no" title="statement not covered" >    err.neo4j = error.jsonBody;</span>
<span class="cstat-no" title="statement not covered" >    err.neo4j.statusCode = statusCode;</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Oct 23 2014 21:01:15 GMT-0700 (PDT)</div>
</div>
